...
*
* \funcusage
*  \snippet Pin_sda_SUT.c usage_Pin_sda_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_sda_SUT.c usage_Pin_sda_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_sda_SUT.c usage_Pin_sda_Read  
*******************************************************************************/
...
* preferred Pin_sda_Read() API because the 
* Pin_sda_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_sda_SUT.c usage_Pin_sda_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_sda_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_sda_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_sda_0_INTR       (First pin in the list)
    *  - Pin_sda_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_sda_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_sda_SUT.c usage_Pin_sda_SetInterruptMode
    *******************************************************************************/
    void Pin_sda_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_sda_0_INTR) != 0u) 
		{ 
			 Pin_sda_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_sda_SUT.c usage_Pin_sda_ClearInterrupt
    *******************************************************************************/
