...
{
    #ifdef isr_Ctrl_INTERRUPT_INTERRUPT_CALLBACK
        isr_Ctrl_Interrupt_InterruptCallback();
    #endif /* isr_Ctrl_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling isr_Ctrl_Start or isr_Ctrl_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_Ctrl_Start or isr_Ctrl_StartEx has been called. 
