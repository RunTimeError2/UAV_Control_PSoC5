...
****************************************************************************//**
*
*  This function forces a USB J, K, or SE0 state on the D+/D每 lines. It provides
...
*    State                      |Description
*    ---------------------------|----------------------------------------------
*    USBUART_1_FORCE_J   | Force a J State onto the D+/D每 lines
*    USBUART_1_FORCE_K   | Force a K State onto the D+/D每 lines
*    USBUART_1_FORCE_SE0 | Force a Single Ended 0 onto the D+/D每 lines
